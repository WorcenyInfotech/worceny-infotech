      ...
      <div className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div
                className="detail-hero-el inline-flex items-center gap-2.5 px-4 py-2 rounded-full mb-6"
                style={{
              ...
              <h1
                className="detail-hero-el text-4xl md:text-6xl font-black mb-4 leading-tight"
                style={{ color: "var(--text)" }}
              >
                {service.title}
              </h1>
              <p
                className="detail-hero-el text-xl font-medium mb-6"
                style={{ color: service.accent }}
              >
                {service.subtitle}
              </p>
              <p
                className="detail-hero-el text-base leading-relaxed mb-8"
                style={{ color: "var(--muted)" }}
              >
                {service.desc}
              </p>
              ...
              <div className="detail-hero-el flex flex-wrap gap-4">
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    boxShadow: `0 0 32px ${service.accent}55`,
                  }}
                  whileTap={{ scale: 0.96 }}
                  onClick={() => {
                    router.push("/contact");
                  ...
                  onClick={() => {
                    if (window.Calendly) {
                      window.Calendly.initPopupWidget({
                        url: "https://calendly.com/worcenyinfotech/new-meeting",
                      });
                    } else {
                      window.open(
                        "https://calendly.com/worcenyinfotech/new-meeting",
                        "_blank"
                      );
                    }
                  }}
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    top: "32px",
                    left: "32px",
                    border: `1px dashed ${service.accent}50`,
                  }}
                />
                {/* Center icon */}
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle, ${service.accent}20, ${service.accent}05)`,
                    border: `2px solid ${service.accent}25`,
                  }}
                >
                  <motion.div
                ...
                {/* Floating number */}
                <div
                  className="absolute -top-4 -right-4 w-14 h-14 rounded-2xl flex items-center justify-center font-black text-lg"
                  style={{ background: service.accent, color: "#fff" }}
                >
                  {service.number}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 mb-20">
          ...
          <div className="text-center mb-10">
            ...
            <p
              ...
              style={{ color: "var(--muted)" }}
            >
              Industry-leading tools and frameworks we use to deliver this
              service with precision and performance.
            </p>
          </div>
          ...
          >
              ...
              {service.technologies.map((tech, i) => {
                ...
                return (
                  <Wrapper
                    ...
                    whileHover={{
                      y: -8,
                      boxShadow: `0 12px 28px ${service.accent}25`,
            ...
            <div
              ...
              style={{
                background: `linear-gradient(90deg, transparent, ${service.accent}40)`,
              }}
            />
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {service.process.map((step, i) => (
            <motion.div
              ...
              whileHover={{
                y: -8,
                boxShadow: `0 20px 50px ${service.accent}20`,
              }}
            ...
            >
              {/* Step number bg */}
              <span
                className="absolute top-4 right-4 text-5xl font-black select-none"
      ...
      <div className="max-w-7xl mx-auto px-6 mb-20">
        ...
        >
          <div
            ...
            style={{
              background: `radial-gradient(circle at 50% 0%, ${service.accent}12, transparent 60%)`,
            }}
          />
          <h2
          ...
          <div className="flex flex-wrap gap-4 justify-center relative z-10">
            <motion.button
              whileHover={{
                scale: 1.06,
                boxShadow: `0 0 36px ${service.accent}55`,
              }}
              whileTap={{ scale: 0.95 }}
              onClick={() => {
                router.push("/contact");
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          {prevService ? (
            <motion.button
              whileHover={{
                x: -4,
                boxShadow: `0 0 20px ${prevService.accent}25`,
              }}
              whileTap={{ scale: 0.97 }}
              onClick={() => {
                router.push(`/services/${prevService.id}`);
                window.scrollTo({ top: 0 });
              }}
              className="flex items-center gap-3 px-6 py-4 rounded-2xl text-sm font-semibold cursor-pointer"
              style={{
                background: "var(--card-bg)",
                border: `1px solid ${prevService.accent}25`,
                color: "var(--text-card)",
              }}
            >
          ...
          {nextService ? (
            <motion.button
              whileHover={{
                x: 4,
                boxShadow: `0 0 20px ${nextService.accent}25`,
              }}
              whileTap={{ scale: 0.97 }}
              onClick={() => {
                router.push(`/services/${nextService.id}`);
                window.scrollTo({ top: 0 });
              }}
              className="flex items-center gap-3 px-6 py-4 rounded-2xl text-sm font-semibold cursor-pointer"
              style={{
                background: "var(--card-bg)",
                border: `1px solid ${nextService.accent}25`,
                color: "var(--text-card)",
              }}
            >
