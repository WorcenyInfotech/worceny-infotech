      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-base max-w-2xl mx-auto" style={{ color: 'var(--muted)' }}>
            We bring deep domain expertise across a wide range of industries — delivering
            tailored digital solutions that drive real results.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {displayed.map((industry, i) => (
            ...
            >
              ...
              <p className="text-xs font-semibold mb-2" style={{ color: industry.accent }}>
                {industry.subtitle}
              </p>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {industry.stats.slice(0, 3).map((stat) => (
                  ...
                  >
                    <span className="text-sm font-black" style={{ color: industry.accent }}>
                      {stat.v}
                    </span>
