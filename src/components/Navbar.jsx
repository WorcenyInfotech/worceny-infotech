...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    else if (location.pathname.startsWith("/services")) setActiveLink("Services");
    else if (location.pathname.startsWith("/industries")) setActiveLink("Industries");
    else if (location.pathname.startsWith("/technologies")) setActiveLink("Technologies");
              ...
              >
                ...
                >
                  <span
                    className="transition-colors duration-300"
                    style={{
                      color: isActive || open ? "var(--accent)" : "var(--muted)",
                    }}
                    onMouseEnter={(e) => {
                      if (!isActive && !open)
            ...
            <ul className="flex flex-col px-6 py-5 gap-1">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <button
                        ...
                        onClick={() =>
                          setMobileMega(expanded ? null : key)
                        }
              ...
              {[
                ...
                <motion.li
                  ...
                  transition={{
                    delay:
                      (simpleLinks.length + megaKeys.length + i) * 0.06,
                  }}
                >
                  <button
                    onClick={() => handleNav(link)}
              ...
              <motion.li
                ...
                transition={{
                  delay:
                    (simpleLinks.length + megaKeys.length + 2) * 0.06,
                }}
              >
                <button
                  onClick={() => {
