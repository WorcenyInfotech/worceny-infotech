    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Image gallery */}
          <div
            className="w-full h-52 rounded-2xl mb-4 relative overflow-hidden"
          ...
          <span
            className="text-xs px-3 py-1 rounded-full mb-4 inline-block font-semibold"
            style={{
          ...
          <h3 className="text-xl font-black mb-3" style={{ color: "#111" }}>
            {project.title}
          </h3>
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className="absolute top-4 left-5 text-8xl font-black select-none pointer-events-none z-0"
          ...
          >
            <span
              className="flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold bg-white"
              style={{ color: project.accent }}
            >
        ...
        >
          ...
          {/* Title */}
          <h3
            className="text-xl lg:text-[26px] font-black mb-2.5 leading-tight tracking-tight"
            style={{ color: "#0b1220" }}
          >
            {project.title}
          </h3>
          ...
          <div className="flex flex-wrap gap-3">
            <motion.button
              whileHover={{
                scale: 1.05,
                boxShadow: `0 0 24px ${project.accent}45`,
              }}
              whileTap={{ scale: 0.97 }}
              onClick={() => onSelect(project)}
