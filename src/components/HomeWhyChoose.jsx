      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
          ...
          >
            ...
            >
              Why Choose{' '}
              <span className="gradient-text">Worceny Infotech</span>
            </h2>
            <p className="text-base leading-relaxed mb-10" style={{ color: 'var(--muted)' }}>
              We don't just build websites — we build digital experiences that grow your
              business. Here's what sets us apart from the rest.
            </p>
          ...
          {[
            {
              label: 'Our Mission',
              text:
                'To empower businesses of all sizes with world-class digital solutions — built with integrity, delivered with excellence, and supported with care.',
              accent: '#2d4dca',
              accent2: '#7528f1',
            },
            {
              label: 'Our Vision',
              text:
                'To become the most trusted digital partner for growing businesses globally — where every project we touch becomes a success story.',
              accent: '#7528f1',
              accent2: '#2d4dca',
            },
          ].map((item) => (
