  ...
  return (
    <section className="max-w-7xl mx-auto px-6 mb-20">
      ...
      >
        ...
        <div className="w-full h-0.5 rounded-full mb-8" style={{ background: `linear-gradient(90deg, ${accent}, transparent)` }} />
          ...
          {technologies.map((tech, i) => (
            ...
            >
              {typeof tech === 'object' && tech.icon ? (
                ...
                <span className="text-sm font-semibold text-center" style={{ color: 'var(--text-card)' }}>
        ...
        <div className="w-full h-0.5 rounded-full mt-8" style={{ background: `linear-gradient(90deg, transparent, ${accent})` }} />
      </motion.div>
    </section>
  )
}
