...
const services = [
...

  {
    ...
    techs: [
      ...
      { name: "Google Search Console", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg" },
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                background: "#ffffff",
                boxShadow:
                  "0 8px 48px rgba(0,0,0,0.22), 0 0 0 1px rgba(134,90,255,0.1)",
              }}
            >
              {/* Top accent bar */}
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
                {current.techs.map((tech, i) => (
                  <motion.div
                    ...
                    whileHover={{
                      y: -5,
                      boxShadow: "0 8px 20px rgba(134,90,255,0.15)",
                    }}
