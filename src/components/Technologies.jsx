        ...
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                background: "#ffffff",
                boxShadow: "0 8px 48px rgba(0,0,0,0.14), 0 0 0 1px rgba(134,90,255,0.1)",
              }}
            >
              {/* Top accent bar */}
              ...
              {/* Heading */}
              <h3 className="text-2xl font-black mb-3" style={{ color: "#111" }}>
                {current.heading}
              </h3>
              ...
              <div className="mt-auto pt-4 border-t border-gray-100">
                <motion.button
                  whileHover={{ scale: 1.03, boxShadow: "0 0 28px rgba(134,90,255,0.35)" }}
                  whileTap={{ scale: 0.97 }}
                  onClick={() => { navigate(`/technologies`); window.scrollTo({ top: 0 }); }}
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <div className="absolute inset-0"
                style={{ background: "linear-gradient(to top, rgba(8,8,12,0.95) 0%, rgba(8,8,12,0.3) 50%, transparent 100%)" }} />
