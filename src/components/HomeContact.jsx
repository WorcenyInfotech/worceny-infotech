...
export default function HomeContact() {
  ...
  return (
    <section ref={sectionRef} style={{ background: 'var(--bg)' }} className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-base max-w-2xl mx-auto" style={{ color: 'var(--muted)' }}>
            Have a project in mind? Fill out the form below or reach out directly — we
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {contactInfo.map((item, i) => (
            ...
            >
              ...
              <div className="text-xs mb-1" style={{ color: 'var(--muted-card)' }}>
                {item.label}
              </div>
              <div
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          >
            ...
            >
              ...
              <p className="text-sm mb-8" style={{ color: 'var(--muted-card)' }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid md:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      >
                        <option value="" disabled style={{ background: '#1a1a2e', color: '#888' }}>
                          Select a service
                        </option>
