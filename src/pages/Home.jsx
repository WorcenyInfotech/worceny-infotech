  ...
  return (
    ...
    >
      ...
      >
        ...
        <div ref={badgeRef} style={{ opacity: 0 }}>
          <div
            ...
            style={{
              ...
              border: "1px solid rgba(134,90,255,0.3)",
            }}
          >
            <span
        ...
        <div
          ref={btnsRef}
          className="flex flex-col sm:flex-row gap-4 justify-center mb-20 w-full px-4 sm:px-0"
        >
          <motion.button
            whileHover={{
              scale: 1.06,
              boxShadow: "0 0 40px rgba(134,90,255,0.55)",
            }}
            whileTap={{ scale: 0.95 }}
            onClick={() => {
              navigate("/contact");
            ...
            className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-base sm:text-base transition-all duration-300 cursor-pointer"
            style={{
              background: "var(--accent)",
              color: "#fff",
              boxShadow: "0 0 24px rgba(134,90,255,0.35)",
            }}
          >
            Contact Us →
          </motion.button>
