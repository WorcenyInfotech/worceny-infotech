    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div ref={headingRef} className="text-center mb-20">
          <span className="inline-block text-[#00ff88] text-sm font-semibold tracking-widest uppercase mb-3">
            Get In Touch
          </span>
          ...
          <div
            ref={lineRef}
            className="w-24 h-0.5 bg-gradient-to-r from-[#00ff88] to-[#00ccff] mx-auto mb-6"
          />
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <motion.button
                    ...
                    whileHover={{
                      scale: 1.02,
                      boxShadow: "0 0 35px rgba(0,255,136,0.45)",
                    }}
                    whileTap={{ scale: 0.97 }}
