    ...
    <div ref={sectionRef} className="min-h-screen pt-18" style={{ background: 'var(--bg)' }}>
      ...
      <div className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <div className="contact-hero-text inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full mb-6"
            ...
            <span className="text-sm font-semibold" style={{ color: 'var(--accent)' }}>Available for Projects</span>
          </div>
          <h1 className="contact-hero-text text-5xl md:text-7xl font-black mb-6" style={{ color: 'var(--text)' }}>
            Let's <span className="gradient-text">Build</span> Something
            <br /><span className="gradient-text-rev">Amazing</span> Together
          </h1>
          <p className="contact-hero-text text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: 'var(--muted)' }}>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid md:grid-cols-2 gap-5">
                    <div>
                      ...
                      {errors.name && <motion.p initial={{opacity:0,y:-4}} animate={{opacity:1,y:0}}
                    ...
                    <div>
                      ...
                      {errors.email && <motion.p initial={{opacity:0,y:-4}} animate={{opacity:1,y:0}}
                        className="text-xs mt-1" style={{ color: '#ff5a5a' }}>{errors.email}</motion.p>}
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
                      {budgets.map(b => (
                        <motion.button key={b} type="button"
                          ...
                          style={form.budget === b
                            ? { background: 'rgba(134,90,255,0.2)', border: '1px solid var(--accent)', color: 'var(--accent)' }
                  ...
                  <div>
                    ...
                    {errors.message && <motion.p initial={{opacity:0,y:-4}} animate={{opacity:1,y:0}}
                      className="text-xs mt-1" style={{ color: '#ff5a5a' }}>{errors.message}</motion.p>}
                  </div>
            ...
            <div className="rounded-3xl p-7" style={{ background: 'var(--card-bg)', border: '1px solid rgba(134,90,255,0.12)' }}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: 'Transparent Pricing',  desc: 'No hidden costs. Fixed quotes.' },
                  { title: '24/7 Support',         desc: "We're always here for you." },
                  { title: 'Modern Tech Stack',    desc: 'React, Node.js, Next.js & more.' },
                ].map((item, i) => (
        ...
        <div className="faq-section mb-10">
          <motion.div initial={{ opacity: 0, y: 38 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            className="text-center mb-12">
            <span className="text-sm font-semibold tracking-widest uppercase" style={{ color: 'var(--accent)' }}>FAQ</span>
            <h2 className="text-3xl md:text-4xl font-black mt-3 mb-4" style={{ color: 'var(--text)' }}>
