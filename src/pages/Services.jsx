...
export default function Services() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-0 left-0 w-[600px] h-[400px] rounded-full blur-3xl pointer-events-none"
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div ref={headingRef} className="text-center mb-20">
          ...
          >
            Comprehensive web solutions designed to elevate your digital
            presence.
          </p>
        </div>
        ...
        >
          ...
          <motion.button
            whileHover={{
              scale: 1.05,
              boxShadow: "0 0 28px rgba(134,90,255,0.5)",
            }}
            whileTap={{ scale: 0.96 }}
            onClick={() => {
