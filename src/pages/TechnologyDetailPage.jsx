        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="td-hero-el text-4xl md:text-6xl font-black mb-4 leading-tight" style={{ color: 'var(--text)' }}>
                {group.label}
              </h1>
              <p className="td-hero-el text-xl font-medium mb-6" style={{ color: group.accent }}>
                {group.subtitle}
              </p>
              <p className="td-hero-el text-base leading-relaxed mb-8" style={{ color: 'var(--muted)' }}>
                {group.desc}
              </p>
              <div className="td-hero-el flex flex-wrap gap-4">
                <motion.button
                  whileHover={{ scale: 1.05, boxShadow: `0 0 32px ${group.accent}55` }}
                  whileTap={{ scale: 0.96 }}
            ...
            <div className="flex items-center justify-center">
              <motion.div
                ...
                <motion.div animate={{ rotate: -360 }} transition={{ duration: 14, repeat: Infinity, ease: 'linear' }}
                  ...
                  style={{ top: '32px', left: '32px', border: `1px dashed ${group.accent}50` }} />
      ...
      <div className="max-w-7xl mx-auto px-6 mb-20">
        ...
        <motion.div
            ...
            {group.techs.map((tech, i) => (
              <motion.div
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-[11px] font-bold" style={{ color: group.accent }}>
                    View detail →
                  </span>
                </div>
              </motion.div>
          ...
          <div className="w-full h-px rounded-full mt-8"
            style={{ background: `linear-gradient(90deg, transparent, ${group.accent}40)` }} />
        </motion.div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-20">
        <motion.div
          ...
          <div className="flex flex-wrap gap-4 justify-center relative z-10">
            <motion.button
              whileHover={{ scale: 1.06, boxShadow: `0 0 36px ${group.accent}55` }}
              whileTap={{ scale: 0.95 }}
              onClick={() => { navigate('/contact'); window.scrollTo({ top: 0 }) }}
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          {prev ? (
            <motion.button whileHover={{ x: -4 }} whileTap={{ scale: 0.97 }}
              onClick={() => { navigate(`/technologies/${prev.id}`); window.scrollTo({ top: 0 }) }}
          ...
          {next ? (
            <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.97 }}
              onClick={() => { navigate(`/technologies/${next.id}`); window.scrollTo({ top: 0 }) }}
              className="flex items-center gap-3 px-6 py-4 rounded-2xl text-sm font-semibold cursor-pointer"
