...
function TechCard({ tech, accent, index, groupId }) {
  ...
  return (
    <motion.div
      ...
      onClick={() => {
        router.push(`/technologies/${groupId}/${tech.slug}`);
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: `0 0 60px ${group.accent}06`,
      }}
    >
      {/* Ambient glow */}
      <div
      ...
      <div className="p-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <span
            className="self-start sm:self-auto text-xs px-4 py-1.5 rounded-full font-semibold"
            style={{
        ...
        <div className="flex justify-end">
          <motion.button
            whileHover={{
              scale: 1.04,
              boxShadow: `0 0 24px ${group.accent}45`,
            }}
            whileTap={{ scale: 0.97 }}
            onClick={() => {
              router.push(`/technologies/${group.id}`);
              window.scrollTo({ top: 0 });
            }}
...
export default function TechnologiesPage() {
  ...
  const filtered =
    activeFilter === "all"
      ? techGroups
      : techGroups.filter((g) => g.id === activeFilter);
    ...
    >
      ...
      <div className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <div
            className="tech-hero-el inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full mb-6"
            style={{
          ...
          <h1
            className="tech-hero-el text-5xl md:text-7xl font-black mb-6 leading-tight"
            style={{ color: "var(--text)" }}
          >
            Technologies We <span className="gradient-text">Master</span>
          </h1>
          <p
            className="tech-hero-el text-lg max-w-2xl mx-auto leading-relaxed mb-10"
            style={{ color: "var(--muted)" }}
          >
            From frontend frameworks to cloud infrastructure — a complete look
            at the tools and technologies we use to build world-class digital
            products.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <div className="flex flex-wrap gap-2 justify-center">
          ...
          {techGroups.map((g) => (
              ...
              style={
                activeFilter === g.id
                  ? {
                      background: g.accent,
                      color: "#fff",
                      boxShadow: `0 0 20px ${g.accent}50`,
                    }
                  : {
                      background: "var(--card-bg)",
                      color: "var(--muted-card)",
            ...
            >
              <span
                style={{ color: activeFilter === g.id ? "#fff" : g.accent }}
              >
                {g.icon}
              </span>
              {g.label}
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        ...
        >
          ...
          <p
            ...
            style={{ color: "var(--muted)" }}
          >
            We pick the right technology for your project — not the trendiest
            one. Let's talk about what fits your goals.
          </p>
